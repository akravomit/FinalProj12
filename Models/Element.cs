...
namespace Models
{
    public class Element
    {
        ...
        public Element(int _id, string _name, int _strong, int _weak, double _strongMod, double _weakMod) : this (_name, _strong, _weak, _strongMod, _weakMod) { id = _id; }
        public Element (Element other) : this (other.id, other.name, other.StrongAgainst, other.WeakAgainst, other.StrongAgainst, other.WeakModifier) { }
    }
}
