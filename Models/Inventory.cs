...
namespace Models
{
    public class Inventory
    {
        ...
        public Inventory () { }
        public Inventory (int playerID, int itemID, int item_level, bool isHidden)
        {
            PlayerID = playerID; 
            ItemID = itemID; 
        ...
        public Inventory (int id, int playerID, int itemID, int item_level, bool isHidden) : this (playerID, itemID, item_level, isHidden)
        { Id = id; }
        public Inventory (Inventory other) : this (other.Id, other.PlayerID, other.ItemID, other.Item_level, other.IsHidden)
        { }
    }
}
